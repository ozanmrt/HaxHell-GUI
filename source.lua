...
local Utility = {}
local Objects = {}
function HaxHell:DraggingEnabled(frame, parent)
...
local themeStyles = {
    DarkTheme = {
        SchemeColor = Color3.fromRGB(84, 84, 84),
...
function HaxHell.CreateLib(kavName, themeList)
    ...
    HaxHell:DraggingEnabled(MainHeader, Main)
    ...
    function HaxHell:ChangeColor(prope,color)
